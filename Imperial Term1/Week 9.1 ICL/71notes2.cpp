...
// since the name of this file is not 71input1.txt it prints error opening file
// if the name of the file was correct it would carry out the function as in the previous examples