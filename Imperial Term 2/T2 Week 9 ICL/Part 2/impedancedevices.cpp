...
// note the impedance of an inductor is jwL so omega*inductance value
...
// our task is to add an implementation for the impedance of an inductor and include it for testing within the main