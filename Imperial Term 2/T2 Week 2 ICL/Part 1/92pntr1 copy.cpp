...
int main(){
    ...
    *pi = 3;
    ...
    // the delete pi deallocates the memory so it isn't available/designated anymore

    // we need a pi = new int; to use *pi = 4
    // *pi = 4;
    ...
    // note you can't ask a NULL pointer its value
